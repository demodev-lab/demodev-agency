...
export default async function Workshop() {
  return (
    <main className="min-h-screen bg-white overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {curriculum.map((week) => (
              <div
                key={week.week}
                className={
                  "bg-white rounded-2xl shadow-xl overflow-hidden hover-card animate-on-scroll delay"
                }
              >
      ...
      <div className="py-20 bg-white">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-2xl p-8 hover-card transition-all duration-300 animate-on-scroll delay">
      ...
      <div id="signup" className="py-20 bg-gradient-to-b from-white to-gray-50">
          ...
          <div className="relative z-10 p-8 md:p-12 bg-white rounded-2xl shadow-xl animate-on-scroll">
            ...
            <div className="relative">
              ...
              <p className="mb-10 text-xl leading-relaxed text-gray-600">
                ...
                <br className="hidden sm:block" />
                <span className="font-semibold text-blue-600">한정 인원만</span>
                모집합니다.
              </p>
