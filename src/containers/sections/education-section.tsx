...
export default function EducationSection() {
  return (
    <div className="py-24 bg-gradient-to-r from-gray-50 to-gray-100 relative overflow-hidden">
      {/* 배경 효과 */}
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="bg-white rounded-2xl p-10 shadow-xl hover-card animate-on-scroll delay-100 relative overflow-hidden group">
            ...
            <div className="flex items-center mb-8 relative">
              <div className="flex items-center justify-center w-14 h-14 rounded-full bg-primary-100 mr-4">
            ...
            <ul className="space-y-4 mb-10 relative z-10">
              ...
              <li className="flex items-start">
                <CheckIcon className="h-6 w-6 text-primary-500 mr-3 flex-shrink-0" />
                <span className="text-gray-600">실전 중심의 오프라인 교육</span>
              </li>
              <li className="flex items-start">
                <CheckIcon className="h-6 w-6 text-primary-500 mr-3 flex-shrink-0" />
            ...
            <div className="relative z-10">
              ...
              <Link
                href="/challenge"
                className="inline-flex items-center justify-center w-full px-6 py-4 text-base font-medium text-white rounded-xl bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1"
              >
                자세히 알아보기
          ...
          <div className="bg-white rounded-2xl p-10 shadow-xl hover-card animate-on-scroll delay-200 relative overflow-hidden group">
            ...
            <div className="flex items-center mb-8 relative">
              <div className="flex items-center justify-center w-14 h-14 rounded-full bg-blue-100 mr-4">
            ...
            <div className="relative z-10">
              ...
              <Link
                href="/workshop"
                className="inline-flex items-center justify-center w-full px-6 py-4 text-base font-medium text-white rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1"
              >
                자세히 알아보기
                <ArrowRightIcon className="w-5 h-5 ml-2" />
              </Link>
