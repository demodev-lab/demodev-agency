        ...
        <div className="max-w-3xl">
          ...
          >
            <h1 className="mb-6 text-4xl font-bold leading-tight text-white sm:text-5xl md:text-6xl lg:text-7xl text-center sm:text-left">
              <div className="mb-4">
                <span className="block sm:inline">퀄리티에 대한 </span>
                <span className="gradient-text bg-gradient-to-r from-primary-400 to-blue-400 block sm:inline">
                  확신
                </span>
              </div>
              <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start">
                <span className="block sm:inline">불만족시 </span>
                <span className="mt-2 sm:mt-0 sm:ml-3 px-4 py-2 text-white rounded-lg bg-gradient-to-r from-primary-600 to-primary-500 shadow-lg shadow-primary-500/30 block sm:inline">
                  100% 환불 보장
                </span>
              </div>
            </h1>
